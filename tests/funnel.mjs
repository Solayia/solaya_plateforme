...
for(const path of ['/','/etude','/guide-proprietaire','/confidentialite','/proprietaires/deja-en-location','/proprietaires/nouveau-projet']){const r=await request(path);assert.equal(r.status,200,path);assert.ok((await r.text()).length>500)}
